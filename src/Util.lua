...
--[[
    Generate the quads for the Lock brick
]]
...
--[[
    Generate the quads for the powerup
]]
function GenerateQuadsPowerup(atlas)
    
    local power = {}
    power[1] = love.graphics.newQuad(112, 192, 16, 16, atlas:getDimensions())
    power[2]  = love.graphics.newQuad(32, 192, 16, 16, atlas:getDimensions())
    return power
end

--[[
    Generate the quads for the key
]]
function GenerateQuadsKey(atlas)
    return love.graphics.newQuad(144, 192, 16, 16, atlas:getDimensions())
end
--[[
