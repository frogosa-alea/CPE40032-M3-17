...
function love.load()
    ...
    gFonts = {
        ...
        ['ark'] = love.graphics.newFont('fonts/BACKTO1982.ttf', 32)
    }
    ...
    gTextures = {
        ...
        ['background1'] = love.graphics.newImage('graphics/background1.jpg'),
    ...
    gFrames = {
        ...
        ['lock'] = GenerateQuadsLock(gTextures['main']),
...
--[[
    Simply renders the player's current level
]]
...
--[[
    Simply renders the high score in the game
]]
